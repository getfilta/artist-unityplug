...
namespace Filta.VisualScripting {
    ...
    public class OnScreenDoubleTap : ManualEventUnit<Unit> {
        protected override string hookName => "screenDoubleTap";
        ...
        private void OnScreenDoubleTapped(object sender, EventArgs e) {
            Trigger(_graph, this);
        }
